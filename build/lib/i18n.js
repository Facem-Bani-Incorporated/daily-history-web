...
const STRINGS = {
  en: {
    ...
    longReadLabel: 'THE LONG READ',
    longReadMeta: (w, c, m, src) => `${w.toLocaleString('en')} words · ${c} chapters · ${m} min · ${src} sources`,
    longReadCta: 'The full article — every chapter, the timeline and the sources — is in the Daily History app.',
  ...
  es: {
    ...
    longReadLabel: 'LA HISTORIA COMPLETA',
    longReadMeta: (w, c, m, src) => `${w.toLocaleString('es')} palabras · ${c} capítulos · ${m} min · ${src} fuentes`,
    longReadCta: 'El artículo completo — cada capítulo, la cronología y las fuentes — está en la app Daily History.',
  ...
  de: {
    ...
    longReadLabel: 'DIE GANZE GESCHICHTE',
    longReadMeta: (w, c, m, src) => `${w.toLocaleString('de')} Wörter · ${c} Kapitel · ${m} Min. · ${src} Quellen`,
    longReadCta: 'Der vollständige Artikel — alle Kapitel, die Chronologie und die Quellen — steht in der Daily-History-App.',
  ...
  fr: {
    ...
    longReadLabel: 'LE RÉCIT COMPLET',
    longReadMeta: (w, c, m, src) => `${w.toLocaleString('fr')} mots · ${c} chapitres · ${m} min · ${src} sources`,
    longReadCta: "L'article complet — chaque chapitre, la chronologie et les sources — se trouve dans l'application Daily History.",
  ...
  ro: {
    ...
    longReadLabel: 'POVESTEA COMPLETĂ',
    longReadMeta: (w, c, m, src) => `${w.toLocaleString('ro')} de cuvinte · ${c} capitole · ${m} min · ${src} surse`,
    longReadCta: 'Articolul complet — fiecare capitol, cronologia și sursele — este în aplicația Daily History.',
